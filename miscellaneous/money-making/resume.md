...
<a href="/chenbook/misc/Chen_Dongtian_Resume.docx" download>Resume</a>
...
- 担任全栈开发工程师，负责构建API、管理应用和与医院系统及第三方医疗平台集成的数据库应用。
- 负责维护和优化电子病历(EMR)系统，包括需求分析和系统改进。
- 领导技术创新项目，提升医院信息系统以符合国家评估标准。
...
- 在IT导师指导下构建API管理系统，后端使用Spring Web MVC、Hibernate和Hadoop，前端使用Bootstrap和jQuery。
...
**全栈开发工程师** – 华中科技大学同济医学院附属同济医院计算机中心

- 构建Node.js/Express服务连接多个Oracle HIS数据库，将患者、医嘱、检验和药房数据统一为REST API，为临床、药房和医务处提供Vue/Quasar仪表板。
- 实施基于JWT的角色控制、操作日志、短信/二维码工具以及用户、报告和专科部门管理的管理工具，加强跨部门工作流程的治理。

### 医院报告上传平台 (2019)
**全栈开发工程师** – 华中科技大学同济医学院附属同济医院计算机中心

- 提供Node.js服务查询双重Oracle HIS/医疗报告系统，验证CAS登录，并编排基于XML的报告上传/取消到医院医疗报告系统网关，包括PDF/图像合并和审计日志。
- 构建Vue 3 + Element Plus工作站，让技术人员筛选患者医嘱、预览历史，并通过浏览器内编辑器生成模板化PDF，该编辑器可自动填写结果、嵌入检验图像，并通过委派凭证检查流式上传。

### 门诊MRCP数据收集平台 (2024)
**全栈开发工程师** - 华中科技大学同济医学院附属同济医院计算机中心

- 构建Node.js/Express服务从Oracle HIS提取门诊就诊信息，通过cron触发批处理归一化为MongoDB MRCP（医疗记录封面页）记录，包含WebSocket进度反馈、PDF/Excel导出以及基于JWT/Bcrypt的角色安全。
- 提供Vue 3 + Quasar单页应用，让编码人员运行批量或单记录收集，使用规则驱动验证编辑MRCP首页，并监控质量仪表板，涵盖就诊统计、指标绩效和数据治理工具。

### 护理单元护理分级管理系统 (2024)

**全栈开发工程师** - 华中科技大学同济医学院附属同济医院计算机中心

- 构建基于JWT的安全Express/Oracle API，用于汇集HIS数据、管理护理单元、程序、工作量覆盖和规则配置，并应用事务安全合并加上分页/验证工具。
- 构建Vue 3 + Element Plus操作控制台，具有标签化工作流程、远程查找组件和嵌入HIS报告，让管理员维护单元到HIS映射并触发自动化工作量再生。

### 医院信息系统评估项目 (2020-2022)
**项目经理兼后端开发工程师** - 华中科技大学同济医学院附属同济医院计算机中心及信息医学研究所
- 解读国家评估标准，领导技术团队完成多项医院信息系统认证
- 改进电子病历系统、医院信息系统和院际通信平台，以满足高级要求和评级标准

### "百度无限"信息搜索竞赛网站 (2015)
**后端开发工程师** - "百度无限"全国大学生信息搜索竞赛
- 构建在线测试系统，从百度题库随机抽题

### 本科教学工作评估系统 (2014-2015)
**后端开发工程师** - 武汉大学
- 开发系统用于显示和管理大学本科教学评估信息
- 为教育部评估生成评估报告

### 医院无线呼叫系统 (2013)
**后端开发工程师** - 十堰太和医院
- 开发呼叫系统，包含一台PC主机和多个Android终端
- 通过Android平板实现患者查询和医院通信
- 为医院提醒和促销实现多媒体消息功能
...
- **数据库：** Oracle, NoSQL
- **前端：** Vue.js
- **报告与分析工具：** FineReport开发

## 语言能力

- **中文：** 母语
- **英语：** 熟练（雅思A类7.5，多邻国145）
- **日语：** 熟练（JLPT N1）
...
### 大学奖项
- **2015年**：武汉大学硕士学位奖学金 - 二等学业奖学金
- **2014年**：武汉大学硕士学位奖学金 - 一等学业奖学金
- **2010年**：全国大学生英语竞赛二等奖
```
##